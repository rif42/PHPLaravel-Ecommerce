...
var KTLogin = function () {
    ...
    var _handleFormReset = function () {
        var form = KTUtil.getById('kt_reset_form');
        var formSubmitUrl = KTUtil.attr(form, 'action');
        var formSubmitButton = KTUtil.getById('kt_reset_form_submit_button');
    ...
    var _handleFormConfirm = function () {
        var form = KTUtil.getById('kt_confirm_form');
        var formSubmitUrl = KTUtil.attr(form, 'action');
        var formSubmitButton = KTUtil.getById('kt_confirm_form_submit_button');
