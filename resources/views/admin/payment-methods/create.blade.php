    ...
    <div class="card card-custom card-sticky mt-15" id="kt_page_sticky_card">
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label">
                    Add New Payment Method <i class="mr-2"></i>
        ...
        <div class="card-body">
            <!--begin::Form-->
            <form class="form" id="kt_form" method="POST" action="{{ route('admin.payment-methods.store') }}" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-solid @error('icon') is-invalid @enderror"
                                           type="file" name="icon" value="{{ old('icon') }}" required autocomplete="off" />
                                    @error('icon')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-solid @error('account_number') is-invalid @enderror"
                                           type="text" name="account_number" value="{{ old('account_number') }}" required autocomplete="off" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-solid @error('account_owner') is-invalid @enderror"
                                           type="text" name="account_owner" value="{{ old('account_owner') }}" required autocomplete="off" />
                                    @error('account_owner')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
