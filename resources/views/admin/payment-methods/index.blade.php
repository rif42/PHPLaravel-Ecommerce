    ...
    <div class="card card-custom">
        <div class="card-header">
            ...
            <span class="card-icon">
                ...
                <h3 class="card-label">Payment Method List</h3>
            </div>
...
@section('scripts')
    ...
    {{-- page scripts --}}
    <script src="{{ asset('js/pages/admin/payment-methods/index.js') }}" type="text/javascript"></script>
